        ...
        <form onSubmit={editProductHandler}>
            <Box sx={style}>
                <FormControl sx={style2}>
                    <TextField defaultValue={product.title} inputRef={title} sx={style4} label="Title" color='warning'  />
                </FormControl>

                <FormControl sx={style2}>
                    <TextField defaultValue={product.description} inputRef={description} multiline minRows='3' maxRows="6" sx={style4} label="Description" color='warning'/>
                </FormControl>

                <FormControl sx={style2}>
                    <input width="200" height="120"  type='image' src={product.image_url} label="Image" color='warning' />
                </FormControl>  

                <FormControl sx={style2}>
                    <TextField onChange={() => {convertImageToBase64(image_url.current.files[0])}} inputRef={image_url} type='file' sx={style4} label="Image" color='warning' />
                </FormControl>

                <FormControl sx={style2}>
                    <TextField defaultValue={product.price} inputRef={price} type='number' sx={style4} label="Price" color='warning' />
                </FormControl> 
                ...
                <FormControl sx={style2}>
                    ...
                    >
                        ...
                        <MenuItem value={'Pasta/Rice'}>Pasta/Rice</MenuItem>
                    </Select>
                </FormControl>
                ...
                <div style={{margin:'4px 4px'}}>
                    ...
                    }} style={{backgroundColor:'rgb(244, 130, 31)'}} type="submit" variant="contained">Submit</Button>
                </div> 
            </Box>
        </form>
      </Modal>
